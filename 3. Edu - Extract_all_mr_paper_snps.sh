...
do
qctool -g $DIR1/data.chr"$i".bgen -og $DIR2/"$i"_snp.dosage.gen -s $DIR3/data.chr01.sample -omit-chromosome -incl-rsids $DIR2/education_snps.txt -excl-samples $DIR2/biobank_exclusion_list_unique_ids.txt
done
